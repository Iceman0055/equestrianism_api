 ...
 * 2018/3/8
 */
public class ConsultingRoomInfoDetailBO extends BaseObject {
    ...
    public ConsultingRoomInfoDetailBO() {
    }

    public ConsultingRoomInfoDetailBO( String consultingRoomId, String name, String shortName, String remark, Integer status ) {
